    ...
    internal static class Program
    {
        ...
        private static void Main()
        {
            ...
            omni.Initialize(
                ...
                , "<!!__PROJECTNAME__!!>_DEBUG", "WinterLeaf.Demo.Full.Dedicated.dll", "Winterleaf.Demo.Full.Dedicated", "csScripts");
#else
            omni.Initialize(
                new[] { "-dedicated", "-mission", @"levels/Empty_Terrain.mis" } 
                , "<!!__PROJECTNAME__!!>", "WinterLeaf.Demo.Full.Dedicated.dll", "Winterleaf.Demo.Full.Dedicated", "csScripts");
#endif
