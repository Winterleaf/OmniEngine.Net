    ...
    public class DOFPostEffect : PostEffect, IConvertible
        ...
        */
        ...
        public virtual void setLerpDist(string d0, string d1, string d2)
            {
            this["lerpScale"] = (-1.0/d0.AsFloat()).AsString() + " " + (-1.0/d1.AsFloat()).AsString() + " " +
                                (-1.0/d2.AsFloat()).AsString() + " " + (1.0/d2.AsFloat()).AsString();
        ...
        public virtual void autoFocus()
            ...
            const uint mask =
                (uint)
                    (SceneObjectTypesAsUint.StaticObjectType |
                     SceneObjectTypesAsUint.TerrainObjectType);
        ...
        [ConsoleInteraction(true)]
        public void setFocusParams(float nearBlurMax, float farBlurMax, float minRange, float maxRange,
            float nearSlope, float farSlope)
            {
