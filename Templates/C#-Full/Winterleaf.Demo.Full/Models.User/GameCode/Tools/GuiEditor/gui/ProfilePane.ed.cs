...
namespace WinterLeaf.Demo.Full.Models.User.GameCode.Tools.GuiEditor.gui
{
    ...
    public class ProfilePane : GuiWindowCtrl
    {
        ...
        private GuiControl mainGuiControl
        {
            get
            {
                return this["mainGuiControl"];
            }
            set
            {
                this["mainGuiControl"] = value;
            }
        }
        ...
        public void createMainControl()
        {
            ...
            if (externalControl == "")
            {
                ...
                {
                    mainGuiControl =
                        Util.eval("return %temp = new " + controlProfile["controlBound"] +
                                  "() { HorizSizing = \"center\"; text= \"TEXT\"; VertSizing = \"center\"; Extent = \"130 30\"; internalName = \"tempGuiControl\"; Position =\"" +
                ...
                else
                {
                    mainGuiControl =
                        Util.eval(
                            "return %temp = new GuiControl() { HorizSizing = \"center\"; VertSizing = \"center\"; Extent = \"130 30\"; internalName = \"tempGuiControl\"; Position =\"" +
                            position.x + " " + position.y + "\"; };");
                }
            }
            else
            {
                mainGuiControl =
                        Util.eval("return %temp = new " + externalControl +
                                  "() { HorizSizing = \"center\"; text= \"TEXT\"; VertSizing = \"center\"; Extent = \"130 30\"; internalName = \"tempGuiControl\"; Position =\"" +
                                  position.x + " " + position.y + "\"; };");
            }
        ...
        public class ProfileColorButton : GuiBitmapButtonTextCtrl
        {
            ...
            public override void onClick(string SelectedidString)
            {
                ...
                if (ProfilePane.controlProfile != 0)
                {
                    ...
                    ColorPickerDlg.GetColorI(ColorPickerDlg.ColorFloatToInt(swatchButton.color.AsString()),
                        getId() + ".setDataColor", swatchButton.getRoot(), "", "");
                }
            }
