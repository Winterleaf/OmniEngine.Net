...
namespace WinterLeaf.Demo.Full.Models.User.GameCode.Tools.InGameEditor.gui
    ...
    public class WindowSettings : GuiControl
        ...
        public static void initialize()
            ...
            ObjectCreator oc_Newobject17 = new ObjectCreator("GuiControl", "WindowSettings, IngameGuiGroup",
            ...
            oc_Newobject4["command"] =
                "$ThisControl.getParent().updateFromChild($ThisControl); WindowSettings.setAlphaValueControl($ThisControl.getValue());";
            ...
            oc_Newobject10["altCommand"] =
                "$ThisControl.getParent().updateFromChild($ThisControl); WindowSettings.setMouseOverAlphaValueControl($ThisControl.getValue() );";
