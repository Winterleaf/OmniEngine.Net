    ...
    public class ShapeEditorActions
        ...
        public class ActionAddMeshFromFile : BaseShapeEdAction
            ...
            public static implicit operator ActionAddMeshFromFile(int simobjectid)
                {
                return
                    (ActionAddMeshFromFile) Omni.self.getSimObject((uint) simobjectid, typeof (ActionAddMeshFromFile));
                }
        ...
        public class ActionAddSequence : BaseShapeEdAction
            ...
            public override bool doit()
                ...
                bool success =
                    ShapeEditor.shape.addSequence(this["from"], this["seqName"], this["start"].AsInt(), this["end"].AsInt());
        ...
        public class ActionAddTrigger : BaseShapeEdAction
            ...
            public override bool doit()
                ...
                if (ShapeEditor.shape.addTrigger(this["seqName"], this["frame"].AsInt(), this["state"].AsInt()))
                    {
                    ShapeEdPropWindow.update_onTriggerAdded(this["seqName"], this["frame"].AsInt(),
                        this["state"].AsFloat());
                    return true;
                    }
                return false;
            ...
            public override void undo()
                ...
                if (ShapeEditor.shape.removeTrigger(this["seqName"], this["frame"].AsInt(), this["state"].AsInt()))
                    ShapeEdPropWindow.update_onTriggerRemoved(this["seqName"], this["frame"].AsInt(),
                        this["state"].AsFloat());
                }
        ...
        public class ActionEditBlend : BaseShapeEdAction
            ...
            public override bool doit()
                ...
                if (this["blend"].AsBool() && this["oldBlend"].AsBool())
                    {
                    if (
                        !ShapeEditor.shape.setSequenceBlend(this["seqName"], false,
                            this["oldBlendSeq"], this["oldBlendFrame"].AsInt()))
                        return false;
                    }

                if (
                    ShapeEditor.shape.setSequenceBlend(this["seqName"], this["blend"].AsBool(), this["blendSeq"],
                        this["blendFrame"].AsInt()))
                    {
                    ShapeEdPropWindow.update_onSequenceBlendChanged(this["seqName"], this["blend"].AsBool(),
                        this["oldBlendSeq"], this["oldBlendFrame"].AsInt(), this["blendSeq"], this["blendFrame"].AsInt());
                    return true;
                    }
                return false;
                }
            ...
            public override void undo()
                ...
                if (this["blend"].AsBool() && this["oldBlend"].AsBool())
                    {
                    if (
                        !ShapeEditor.shape.setSequenceBlend(this["seqName"], false, this["blendSeq"],
                            this["blendFrame"].AsInt()))
                        return;
                    }

                if (
                    ShapeEditor.shape.setSequenceBlend(this["seqName"], this["oldBlend"].AsBool(), this["oldBlendSeq"],
                        this["oldBlendFrame"].AsInt()))
                    {
                    ShapeEdPropWindow.update_onSequenceBlendChanged(this["seqName"], !this["blend"].AsBool(),
                        this["blendSeq"], this["blendFrame"].AsInt(), this["oldBlendSeq"], this["oldBlendFrame"].AsInt());
                    }
                }
        ...
        public class ActionEditCollision : BaseShapeEdAction
            {
            [ConsoleInteraction]
            public bool updateCollision(string type, string target, int depth, float merge, float concavity,
                int maxVerts, float boxMax, float sphereMax, float capsuleMax)
                {
                ShapeEditor ShapeEditor = "ShapeEditor";
                ShapeEdPropWindow ShapeEdPropWindow = "ShapeEdPropWindow";
                ...
                ShapeEdColWindow["lastColSettings"] = type + '\t' + target + '\t' + depth + '\t' + merge + '\t' +
                                                      concavity + '\t' + maxVerts + '\t' + boxMax + '\t' + sphereMax +
                                                      '\t' + capsuleMax;
            ...
            public override bool doit()
                ...
                bool success = this.updateCollision(this["newType"], this["newTarget"], this["newDepth"].AsInt(),
                    this["newMerge"].AsFloat(),
                    this["newConcavity"].AsFloat(), this["newMaxVerts"].AsInt(), this["newBoxMax"].AsFloat(),
                    this["newSphereMax"].AsFloat(), this["newCapsuleMax"].AsFloat());
                ShapeEdWaitGui.hide();
            ...
            public override void undo()
                ...
                ShapeEdWaitGui.show("Generating collision geometry...");
                this.updateCollision(this["oldType"], this["oldTarget"], this["oldDepth"].AsInt(), this["oldMerge"].AsFloat(),
                    this["oldConcavity"].AsFloat(), this["oldMaxVerts"].AsInt(), this["oldBoxMax"].AsFloat(),
                    this["oldSphereMax"].AsFloat(), this["oldCapsuleMax"].AsFloat());
                ShapeEdWaitGui.hide();
                }
        ...
        public class ActionEditCyclic : BaseShapeEdAction
            ...
            public override void undo()
                ...
                if (
                    ShapeEditor.shape.setSequenceCyclic(this["seqName"], (!this["cyclic"].AsBool())))
                    ShapeEdPropWindow.update_onSequenceCyclicChanged(this["seqName"], !this["cyclic"].AsBool());
                }
        ...
        public class ActionEditImposter : BaseShapeEdAction
            ...
            public override bool doit()
                ...
                int dl = ShapeEditor.shape.addImposter(this["newSize"].AsInt(), val[1].AsInt(), val[2].AsInt(), val[3].AsInt(), val[4].AsInt(),
                    val[5].AsBool(), val[6].AsFloat());
                ShapeEdWaitGui.hide();
            ...
            public override void undo()
                ...
                if (this["oldDL"].AsInt() < 0)
                    ...
                    int dl = ShapeEditor.shape.addImposter(this["oldSize"].AsInt(), val[1].AsInt(), val[2].AsInt(), val[3].AsInt(), val[4].AsInt(),
                        val[5].AsBool(), val[6].AsFloat());
                    ShapeEdWaitGui.hide();
        ...
        public class ActionEditMeshBillboard : BaseShapeEdAction
            ...
            public static implicit operator ActionEditMeshBillboard(int simobjectid)
                {
                return
                    (ActionEditMeshBillboard)
                        Omni.self.getSimObject((uint) simobjectid, typeof (ActionEditMeshBillboard));
                }
        ...
        public class ActionEditMeshSize : BaseShapeEdAction
            ...
            public override bool doit()
                ...
                if (
                    ShapeEditor.shape.setMeshSize(this["meshName"] + ' ' + this["oldSize"], this["newSize"].AsInt()))
                    {
            ...
            public override void undo()
                ...
                if (
                    ShapeEditor.shape.setMeshSize(this["meshName"] + " " + this["newSize"], this["oldSize"].AsInt()))
        ...
        public class ActionEditNodeTransform : BaseShapeEdAction
            ...
            public static implicit operator ActionEditNodeTransform(int simobjectid)
                {
                return
                    (ActionEditNodeTransform)
                        Omni.self.getSimObject((uint) simobjectid, typeof (ActionEditNodeTransform));
                }
        ...
        public class ActionEditSeqSource : BaseShapeEdAction
            ...
            public override bool doit()
                ...
                // the existing sequence first, so we can edit the start/end frames later
                // without having to worry if the original source sequence has changed.
                if (!Util.startsWith(this["from"], "__backup__", false) &&
                ...
                if (
                    ...
                    if (newBlend != blend)
                        ...
                        ShapeEditor.shape.setSequenceBlend(this["seqName"], false, Util.getField(newBlend, 1),
                            Util.getField(newBlend, 2).AsInt());
                        if (Util.getField(blend, 0) == "1")
                            ShapeEditor.shape.setSequenceBlend(this["seqName"], Util.getField(blend, 0).AsBool(),
                                Util.getField(blend, 1), Util.getField(blend, 2).AsInt());
                        }

                    if (ShapeEdSequenceList.getSelectedName() == this["seqName"])
                        {
                        ShapeEdSequenceList.editColumn(this["seqName"], 3,
                            (this["end"].AsInt() - this["start"].AsInt() + 1).AsString());
        ...
        public class ActionEditSequenceGroundSpeed : BaseShapeEdAction
            ...
            public static implicit operator ActionEditSequenceGroundSpeed(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (ActionEditSequenceGroundSpeed)
                        Omni.self.getSimObject(simobjectid, typeof (ActionEditSequenceGroundSpeed));
                }
            ...
            public static implicit operator ActionEditSequenceGroundSpeed(int simobjectid)
                ...
                return
                    (ActionEditSequenceGroundSpeed)
                        Omni.self.getSimObject((uint) simobjectid, typeof (ActionEditSequenceGroundSpeed));
                }
        ...
        public class ActionEditSequencePriority : BaseShapeEdAction
            ...
            public static implicit operator ActionEditSequencePriority(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (ActionEditSequencePriority)
                        Omni.self.getSimObject(simobjectid, typeof (ActionEditSequencePriority));
                }
            ...
            public static implicit operator ActionEditSequencePriority(int simobjectid)
                ...
                return
                    (ActionEditSequencePriority)
                        Omni.self.getSimObject((uint) simobjectid, typeof (ActionEditSequencePriority));
                }
        ...
        public class ActionEditTrigger : BaseShapeEdAction
            ...
            public override bool doit()
                ...
                if (ShapeEditor.shape.addTrigger(this["seqName"], this["frame"].AsInt(), this["state"].AsInt()) &&
                    ShapeEditor.shape.removeTrigger(this["seqName"], this["oldFrame"].AsInt(), this["oldState"].AsInt()))
                    {
                    ShapeEdTriggerList.updateItem(this["oldFrame"].AsInt(), this["oldState"].AsFloat(),
                        this["frame"].AsInt(), this["state"].AsFloat());
                    return true;
                    }
                return false;
                }
            ...
            public override void undo()
                ...
                if (
                    ShapeEditor.shape.addTrigger(this["seqName"], this["oldFrame"].AsInt(), this["oldState"].AsInt()) &&
                    ShapeEditor.shape.removeTrigger(this["seqName"], this["frame"].AsInt(), this["state"].AsInt()))
                    ShapeEdTriggerList.updateItem(this["frame"].AsInt(), this["state"].AsFloat(),
                        this["oldFrame"].AsInt(), this["oldState"].AsFloat());
                }
            ...
            public override void redo()
                ...
                if (this.doit())
                    ...
                    messageBox.MessageBoxOK("Error",
                        "Redo" + ' ' + this["actionName"] + ' ' + "failed. Check the console for error messages.", "");
                    }
                }
