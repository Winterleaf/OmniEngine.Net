...
namespace WinterLeaf.Engine.Containers
    ...
    public sealed class TransformF : IConvertible
        ...
        public static bool operator ==(TransformF x, TransformF _test)
            ...
            return
                (x._mOrientation_x == _test._mOrientation_x) &&
                (x._mOrientation_y == _test._mOrientation_y) &&
                (x._mOrientation_z == _test._mOrientation_z) &&
                (x._mPosition_x == _test._mPosition_x) &&
                (x._mPosition_y == _test._mPosition_y) &&
                (x._mPosition_z == _test._mPosition_z) &&
                (x.mAngle == _test.mAngle);
            }
        ...
        public string AsString()
            {
            return string.Format("{0} {1} {2} {3} {4} {5} {6}", mPositionX.AsString(), mPositionY.AsString(),
                mPositionZ.AsString(), mOrientationX.AsString(), mOrientationY.AsString(), mOrientationZ.AsString(),
                mAngle.AsString());
            }
        ...
        public static TransformF operator +(TransformF x, TransformF _add)
            {
            return new TransformF(x.mPositionX + _add.mPositionX, x.mPositionY + _add.mPositionY,
                x.mPositionZ + _add.mPositionZ);
            }
        ...
        public static TransformF operator -(TransformF x, TransformF _rSub)
            {
            return new TransformF(x.mPositionX - _rSub.mPositionX, x.mPositionY - _rSub.mPositionY,
                x.mPositionZ - _rSub.mPositionZ);
            }
        ...
        public bool isZero()
            {
            return ((mPositionX*mPositionX) <= POINT_EPSILON) && ((mPositionY*mPositionY) <= POINT_EPSILON) &&
                   ((mPositionZ*mPositionZ) <= POINT_EPSILON);
            }
