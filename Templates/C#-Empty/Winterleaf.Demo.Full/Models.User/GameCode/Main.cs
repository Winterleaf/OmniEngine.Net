    ...
    public static class Main
        ...
        public static int main(int argc, string[] argv)
            ...
            if (omni.Util.isToolBuild() && !omni.bGlobal["$isDedicated"])
                ...
                WinterLeaf.Demo.Full.Models.User.GameCode.Tools.main.initialize();
        ...
        public static void onMainExit()
            ...
            if (omni.bGlobal["$Server::Dedicated"])
                WinterLeaf.Demo.Full.Models.User.GameCode.Server.server.destroyServer();
            else
        ...
        public static void onMainStart()
            ...
            client.LoadDefaults();
            WinterLeaf.Demo.Full.Models.User.GameCode.Server.server.LoadDefaults();
            ...
            WinterLeaf.Demo.Full.Models.User.GameCode.Server.server.initServer();

            // Start up in either client, or dedicated server mode
            if (omni.bGlobal["$Server::Dedicated"])
                WinterLeaf.Demo.Full.Models.User.GameCode.Server.server.initDedicated();
            else
                WinterLeaf.Demo.Full.Models.User.GameCode.Client.init.initClient();
