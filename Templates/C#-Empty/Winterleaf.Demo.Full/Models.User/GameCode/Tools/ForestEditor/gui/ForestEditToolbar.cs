...
namespace WinterLeaf.Demo.Full.Models.User.GameCode.Tools.ForestEditor.gui
    ...
    public class ForestEditToolbar : GuiControl
        ...
        public static void initialize()
            ...
            ObjectCreator oc_Newobject17 = new ObjectCreator("GuiControl", "ForestEditToolbar,EditorGuiGroup",
                typeof (ForestEditToolbar));
            ...
            ObjectCreator oc_Newobject19 = new ObjectCreator("GuiMouseEventCtrl",
                "ForestBrushSizeSliderCtrlContainer,EditorGuiGroup",
                typeof (ForestEditorGui.ForestBrushSizeSliderCtrlContainer));
            ...
            oc_Newobject18["position"] =
                new ObjectCreator.StringNoQuote(
                    "firstWord(ForestBrushSizeTextEditContainer.position) + firstWord(ForestEditToolbar.position)+11 SPC          (getWord(ForestBrushSizeTextEditContainer, 1)) + 25");
            ...
            oc_Newobject18["range"] =
                new ObjectCreator.StringNoQuote("\"1\" SPC getWord(ETerrainEditor.maxBrushSize, 0)");
            ...
            ObjectCreator oc_Newobject21 = new ObjectCreator("GuiMouseEventCtrl",
                "ForestBrushPressureSliderCtrlContainer,EditorGuiGroup",
                typeof (EditorGui.EditorDropdownSliderContainer));
            ...
            oc_Newobject20["position"] =
                new ObjectCreator.StringNoQuote(
                    "firstWord(ForestBrushPressureTextEditContainer.position) + firstWord(ForestEditToolbar.position) SPC          (getWord(ForestBrushPressureTextEditContainer, 1)) + 25");
            ...
            ObjectCreator oc_Newobject23 = new ObjectCreator("GuiMouseEventCtrl",
                "ForestBrushHardnessSliderCtrlContainer,EditorGuiGroup",
                typeof (EditorGui.EditorDropdownSliderContainer));
            ...
            oc_Newobject22["position"] =
                new ObjectCreator.StringNoQuote(
                    "firstWord(ForestBrushHardnessTextEditContainer.position) + firstWord(ForestEditToolbar.position) SPC          (getWord(TForestBrushHardnessTextEditContainer, 1)) + 25");
