...
namespace WinterLeaf.Demo.Full.Models.User.GameCode.Tools.MeshRoadEditor.gui
    ...
    public class MeshRoadEditorGui : GuiMeshRoadEditorCtrl
        ...
        public static void initialize()
            ...
            ObjectCreator oc_Newobject21 = new ObjectCreator("GuiMeshRoadEditorCtrl", "MeshRoadEditorGui,EditorGuiGroup",
                typeof (MeshRoadEditorGui));
            ...
            ObjectCreator oc_Newobject4 = new ObjectCreator("GuiWindowCollapseCtrl", "MeshRoadEditorTreeWindow",
                typeof (MeshRoadEditorTreeWindow));
            ...
            ObjectCreator oc_Newobject1 = new ObjectCreator("GuiTreeViewCtrl", "MeshRoadTreeView",
                typeof (MeshRoadTreeView));
            ...
            ObjectCreator oc_Newobject20 = new ObjectCreator("GuiWindowCollapseCtrl", "MeshRoadEditorOptionsWindow",
                typeof (MeshRoadEditorOptionsWindow));
            ...
            oc_Newobject20["Position"] =
                new ObjectCreator.StringNoQuote(
                    "getWord($pref::Video::mode, 0) - 209         SPC getWord(EditorGuiToolbar.extent, 1) + getWord(MeshRoadEditorTreeWindow.extent, 1) - 2");
            ...
            ObjectCreator oc_Newobject17 = new ObjectCreator("GuiInspector", "MeshRoadInspector",
                typeof (MeshRoadInspector));
        ...
        public override void onNodeSelected(string nodeIdx)
            ...
            GuiTextEditCtrl positionTextEditCtrl =
                (GuiTextEditCtrl) MeshRoadEditorOptionsWindow.findObjectByInternalName("position", true);
            GuiTextEditCtrl rotationTextEditCtrl =
                (GuiTextEditCtrl) MeshRoadEditorOptionsWindow.findObjectByInternalName("rotation", true);
            GuiTextEditCtrl widthTextEditCtrl =
                (GuiTextEditCtrl) MeshRoadEditorOptionsWindow.findObjectByInternalName("width", true);
            GuiTextEditCtrl depthTextEditCtrl =
                (GuiTextEditCtrl) MeshRoadEditorOptionsWindow.findObjectByInternalName("depth", true);
        ...
        public void onBrowseClicked()
            ...
            {
                InitialDirectory = this["lastPath"],
                Filter = @"All Files (*.*)|*.*",
        ...
        public void prepSelectionMode()
            ...
            ((GuiBitmapButtonCtrl)
                ((GuiDynamicCtrlArrayControl) "ToolsPaletteArray").findObjectByInternalName(
                    "MeshRoadEditorSelectMode", true)).setStateOn(true);
            }
        ...
        public class EMeshRoadEditorAddModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator EMeshRoadEditorAddModeBtn(string ts)
                ...
                return
                    (EMeshRoadEditorAddModeBtn) Omni.self.getSimObject(simobjectid, typeof (EMeshRoadEditorAddModeBtn));
                }
            ...
            public static implicit operator EMeshRoadEditorAddModeBtn(int simobjectid)
                {
                return
                    (EMeshRoadEditorAddModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (EMeshRoadEditorAddModeBtn));
                }
        ...
        public class EMeshRoadEditorInsertModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator EMeshRoadEditorInsertModeBtn(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (EMeshRoadEditorInsertModeBtn)
                        Omni.self.getSimObject(simobjectid, typeof (EMeshRoadEditorInsertModeBtn));
                }
            ...
            public static implicit operator EMeshRoadEditorInsertModeBtn(int simobjectid)
                ...
                return
                    (EMeshRoadEditorInsertModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (EMeshRoadEditorInsertModeBtn));
                }
        ...
        public class EMeshRoadEditorMoveModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator EMeshRoadEditorMoveModeBtn(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (EMeshRoadEditorMoveModeBtn)
                        Omni.self.getSimObject(simobjectid, typeof (EMeshRoadEditorMoveModeBtn));
                }
            ...
            public static implicit operator EMeshRoadEditorMoveModeBtn(int simobjectid)
                ...
                return
                    (EMeshRoadEditorMoveModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (EMeshRoadEditorMoveModeBtn));
                }
        ...
        public class EMeshRoadEditorRemoveModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator EMeshRoadEditorRemoveModeBtn(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (EMeshRoadEditorRemoveModeBtn)
                        Omni.self.getSimObject(simobjectid, typeof (EMeshRoadEditorRemoveModeBtn));
                }
            ...
            public static implicit operator EMeshRoadEditorRemoveModeBtn(int simobjectid)
                ...
                return
                    (EMeshRoadEditorRemoveModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (EMeshRoadEditorRemoveModeBtn));
                }
        ...
        public class EMeshRoadEditorRotateModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator EMeshRoadEditorRotateModeBtn(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (EMeshRoadEditorRotateModeBtn)
                        Omni.self.getSimObject(simobjectid, typeof (EMeshRoadEditorRotateModeBtn));
                }
            ...
            public static implicit operator EMeshRoadEditorRotateModeBtn(int simobjectid)
                ...
                return
                    (EMeshRoadEditorRotateModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (EMeshRoadEditorRotateModeBtn));
                }
        ...
        public class EMeshRoadEditorScaleModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator EMeshRoadEditorScaleModeBtn(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (EMeshRoadEditorScaleModeBtn)
                        Omni.self.getSimObject(simobjectid, typeof (EMeshRoadEditorScaleModeBtn));
                }
            ...
            public static implicit operator EMeshRoadEditorScaleModeBtn(int simobjectid)
                ...
                return
                    (EMeshRoadEditorScaleModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (EMeshRoadEditorScaleModeBtn));
                }
        ...
        public class EMeshRoadEditorSelectModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator EMeshRoadEditorSelectModeBtn(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (EMeshRoadEditorSelectModeBtn)
                        Omni.self.getSimObject(simobjectid, typeof (EMeshRoadEditorSelectModeBtn));
                }
            ...
            public static implicit operator EMeshRoadEditorSelectModeBtn(int simobjectid)
                ...
                return
                    (EMeshRoadEditorSelectModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (EMeshRoadEditorSelectModeBtn));
                }
        ...
        public class MeshRoadDefaultDepthSliderCtrlContainer : EditorGui.EditorDropdownSliderContainer
            ...
            public override void onWake()
                ...
                ((GuiSliderCtrl) (this).findObjectByInternalName("slider", true)).setValue(
                    ((GuiTextEditCtrl)
                        ((GuiControl) "MeshRoadDefaultDepthTextEditContainer").findObjectByInternalName("textEdit",
                            true)).getText());
                }
            ...
            public static implicit operator MeshRoadDefaultDepthSliderCtrlContainer(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (MeshRoadDefaultDepthSliderCtrlContainer)
                        Omni.self.getSimObject(simobjectid, typeof (MeshRoadDefaultDepthSliderCtrlContainer));
                }
            ...
            public static implicit operator MeshRoadDefaultDepthSliderCtrlContainer(int simobjectid)
                ...
                return
                    (MeshRoadDefaultDepthSliderCtrlContainer)
                        Omni.self.getSimObject((uint) simobjectid, typeof (MeshRoadDefaultDepthSliderCtrlContainer));
                }
        ...
        public class MeshRoadDefaultWidthSliderCtrlContainer : EditorGui.EditorDropdownSliderContainer
            ...
            public override void onWake()
                ...
                ((GuiSliderCtrl) (this).findObjectByInternalName("slider", true)).setValue(
                    ((GuiTextEditCtrl)
                        ((GuiControl) "MeshRoadDefaultWidthTextEditContainer").findObjectByInternalName("textEdit",
                            true)).getText());
                }
            ...
            public static implicit operator MeshRoadDefaultWidthSliderCtrlContainer(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (MeshRoadDefaultWidthSliderCtrlContainer)
                        Omni.self.getSimObject(simobjectid, typeof (MeshRoadDefaultWidthSliderCtrlContainer));
                }
            ...
            public static implicit operator MeshRoadDefaultWidthSliderCtrlContainer(int simobjectid)
                ...
                return
                    (MeshRoadDefaultWidthSliderCtrlContainer)
                        Omni.self.getSimObject((uint) simobjectid, typeof (MeshRoadDefaultWidthSliderCtrlContainer));
                }
        ...
        public class MeshRoadEditorOptionsWindow : GuiWindowCollapseCtrl
            ...
            public static implicit operator MeshRoadEditorOptionsWindow(string ts)
                ...
                return
                    (MeshRoadEditorOptionsWindow)
                        Omni.self.getSimObject(simobjectid, typeof (MeshRoadEditorOptionsWindow));
                }
            ...
            public static implicit operator MeshRoadEditorOptionsWindow(int simobjectid)
                ...
                return
                    (MeshRoadEditorOptionsWindow)
                        Omni.self.getSimObject((uint) simobjectid, typeof (MeshRoadEditorOptionsWindow));
                }
            ...
            public static implicit operator MeshRoadEditorTreeWindow(int simobjectid)
                ...
                return
                    (MeshRoadEditorTreeWindow)
                        Omni.self.getSimObject((uint) simobjectid, typeof (MeshRoadEditorTreeWindow));
                }
        ...
        public class MeshRoadInspector : GuiInspector
            ...
            public override void onFieldSelected(string fieldName, string fieldTypeStr, string fieldDoc)
                {
                ((GuiMLTextCtrl) "MeshFieldInfoControl").setText("<font:ArialBold:14>" + fieldName +
        ...
        public static implicit operator MeshRoadEditorGui(string ts)
            ...
            uint simobjectid = resolveobject(ts);
            return
                (MeshRoadEditorGui) Omni.self.getSimObject(simobjectid, typeof (MeshRoadEditorGui));
            }
        ...
        public static implicit operator MeshRoadEditorGui(int simobjectid)
            {
            return
                (MeshRoadEditorGui) Omni.self.getSimObject((uint) simobjectid, typeof (MeshRoadEditorGui));
            }
