...
namespace WinterLeaf.Demo.Full.Models.User.GameCode.Tools.Misc
    ...
    public class ConsoleVarDlg : GuiControl
        ...
        public static void initialize()
            ...
            oc_Newobject7["noCursor"] = new ObjectCreator.StringNoQuote("true");

            #region GuiWindowCtrl (ConsoleVarDlgWindow)        oc_Newobject6

            ObjectCreator oc_Newobject6 = new ObjectCreator("GuiWindowCtrl", "ConsoleVarDlgWindow",
                typeof (ConsoleVarDlgWindow));
