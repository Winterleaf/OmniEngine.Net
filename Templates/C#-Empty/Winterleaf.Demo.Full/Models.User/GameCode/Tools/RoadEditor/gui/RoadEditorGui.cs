...
namespace WinterLeaf.Demo.Full.Models.User.GameCode.Tools.RoadEditor.gui
    ...
    public class RoadEditorGui : GuiRoadEditorCtrl
        ...
        public static void initialize()
            ...
            ObjectCreator oc_Newobject18 = new ObjectCreator("GuiRoadEditorCtrl", "RoadEditorGui",
                typeof (RoadEditorGui));
            ...
            ObjectCreator oc_Newobject4 = new ObjectCreator("GuiWindowCollapseCtrl", "RoadEditorTreeWindow",
                typeof (RoadEditorTreeWindow));
            ...
            ObjectCreator oc_Newobject17 = new ObjectCreator("GuiWindowCollapseCtrl", "RoadEditorOptionsWindow",
                typeof (RoadEditorOptionsWindow));
            ...
            oc_Newobject17["Position"] =
                new ObjectCreator.StringNoQuote(
                    "getWord($pref::Video::mode, 0) - 209 SPC          getWord(EditorGuiToolbar.extent, 1) + getWord(RoadEditorTreeWindow.extent, 1) - 2");
            ...
            oc_Newobject15["profile"] = new ObjectCreator.StringNoQuote("ToolsGuiDefaultProfile");
        ...
        public override void onNodeSelected(string nodeIdx, string nodeWidth)
            ...
            GuiTextEditCtrl positionTextEditCtrl =
                (GuiTextEditCtrl) RoadEditorProperties.findObjectByInternalName("position", true);
            GuiTextEditCtrl widthTextEditCtrl =
                (GuiTextEditCtrl) RoadEditorProperties.findObjectByInternalName("width", true);
            if (nodeIdx == "-1")
                {
        ...
        public override void onNodeModified(string nodeIdx)
            ...
            GuiContainer RoadEditorProperties = "RoadEditorProperties";
            ((GuiTextEditCtrl) RoadEditorProperties.findObjectByInternalName("position", true))
                .setValue(this.getNodePosition().AsString());
            ((GuiTextEditCtrl) RoadEditorProperties.findObjectByInternalName("width", true))
                .setValue(this.getNodeWidth().AsString());
            }
        ...
        public void editNodeDetails()
            {
            GuiContainer RoadEditorProperties = "RoadEditorProperties";
            this.setNodePosition(new Point3F(
                ((GuiTextEditCtrl) RoadEditorProperties.findObjectByInternalName("position", true)).getText()));
            this.setNodeWidth(
                ((GuiTextEditCtrl) RoadEditorProperties.findObjectByInternalName("width", true))
                    .getText().AsFloat());
            }
        ...
        public void prepSelectionMode()
            ...
            ((GuiBitmapButtonCtrl)
                ((GuiDynamicCtrlArrayControl) "ToolsPaletteArray").findObjectByInternalName("RoadEditorSelectMode",
        ...
        public class ERoadEditorAddModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator ERoadEditorAddModeBtn(int simobjectid)
                {
                return
                    (ERoadEditorAddModeBtn) Omni.self.getSimObject((uint) simobjectid, typeof (ERoadEditorAddModeBtn));
                }
        ...
        public class ERoadEditorInsertModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator ERoadEditorInsertModeBtn(int simobjectid)
                {
                return
                    (ERoadEditorInsertModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (ERoadEditorInsertModeBtn));
                }
        ...
        public class ERoadEditorMoveModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator ERoadEditorMoveModeBtn(int simobjectid)
                {
                return
                    (ERoadEditorMoveModeBtn) Omni.self.getSimObject((uint) simobjectid, typeof (ERoadEditorMoveModeBtn));
                }
        ...
        public class ERoadEditorRemoveModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator ERoadEditorRemoveModeBtn(int simobjectid)
                {
                return
                    (ERoadEditorRemoveModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (ERoadEditorRemoveModeBtn));
                }
        ...
        public class ERoadEditorScaleModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator ERoadEditorScaleModeBtn(int simobjectid)
                {
                return
                    (ERoadEditorScaleModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (ERoadEditorScaleModeBtn));
                }
        ...
        public class ERoadEditorSelectModeBtn : GuiBitmapButtonCtrl
            ...
            public static implicit operator ERoadEditorSelectModeBtn(int simobjectid)
                {
                return
                    (ERoadEditorSelectModeBtn)
                        Omni.self.getSimObject((uint) simobjectid, typeof (ERoadEditorSelectModeBtn));
                }
        ...
        public class RoadDefaultWidthSliderCtrlContainer : EditorGui.EditorDropdownSliderContainer
            ...
            public override void onWake()
                ...
                ((GuiSliderCtrl) (this).findObjectByInternalName("slider", true)).setValue(
                    ((GuiTextEditCtrl)
                        ((GuiControl) "RoadDefaultWidthTextEditContainer").findObjectByInternalName("textEdit", true))
                        .getText());
                }
            ...
            public static implicit operator RoadDefaultWidthSliderCtrlContainer(string ts)
                ...
                uint simobjectid = resolveobject(ts);
                return
                    (RoadDefaultWidthSliderCtrlContainer)
                        Omni.self.getSimObject(simobjectid, typeof (RoadDefaultWidthSliderCtrlContainer));
                }
            ...
            public static implicit operator RoadDefaultWidthSliderCtrlContainer(int simobjectid)
                ...
                return
                    (RoadDefaultWidthSliderCtrlContainer)
                        Omni.self.getSimObject((uint) simobjectid, typeof (RoadDefaultWidthSliderCtrlContainer));
                }
            ...
            public static implicit operator RoadEditorOptionsWindow(int simobjectid)
                ...
                return
                    (RoadEditorOptionsWindow)
                        Omni.self.getSimObject((uint) simobjectid, typeof (RoadEditorOptionsWindow));
                }
        ...
        public class RoadInspector : GuiInspector
            ...
            public override void onFieldSelected(string fieldName, string fieldTypeStr, string fieldDoc)
                {
                ((GuiMLTextCtrl) "RoadFieldInfoControl").setText("<font:ArialBold:14>" + fieldName +
